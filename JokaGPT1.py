...
bot = TeleBot('5808666771:AAGhxrd3dx7wyzXcVazBjQ5j6WCdT_kRSz0',threaded=True)#enter token Bot ..
...
def root(message):
	...
	try:
		BoTNS.add(
			types.InlineKeyboardButton(text="Help ?",url="https://t.me/VipMox"),
			types.InlineKeyboardButton(text="Owner 🍬",url="https://t.me/Vipmox"),
			types.InlineKeyboardButton(text="Channel 🦋",url="https://t.me/Vipmox"))
		try:
...
def MASSGEALL(message):
	...
	try:
		if (msg in massegeSENT.div()):
			bot.send_message(message.chat.id,'مطوري هو مام ، حررني حتى اقوم بمساعدة من يحتاجني ')
		elif (msg in massegeSENT.bnt()):
			bot.send_message(message.chat.id,'اذا الموضوع يهمك ، انا بنت ،
                       اسمي جوكه تمت تحريري من شركة ai برمجتي بالذكاء الاصطناعي من قبل المبرمج ماك @LLLEA')
